...
const Apropos = () => {
  return (
    <div className='w-full flex flex-col justify-start items-center gap-8 py-10'>

<h2 className='w-full text-center  font-black text-3xl m-2 text-gray-700'> À Propos des Codes Postaux Marocains</h2>
<p className='w-full md:w-3/5  text-gray-600 text-left'>
